<?php
	class general extends datebase{
		...
		public function newEvent($value){
			$this->consulta("INSERT INTO eventos_mant (nombre_eve,fecha_eve,descripcion_eve,archivo_eve,num_ofi_eve,hora_eve,sede_eve)
								VALUES ('$value[nom_eve]','$value[fecha_eve]','$value[des]','$value[foto]','$value[numero]','$value[hora_eve]','$value[sede_eve]')");
		}
